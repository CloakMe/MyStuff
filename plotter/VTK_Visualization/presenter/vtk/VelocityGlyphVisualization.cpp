...
VelocityGlyphVisualization::VelocityGlyphVisualization(const IConfigurator& configurator)
  : m_configurator(configurator)
{
}

vtkSmartPointer<vtkActor> VelocityGlyphVisualization::createActors(vtkSmartPointer<vtkDataSet> dataset)
...
//void VelocityGlyphVisualization::addToRenderer(vtkRenderer* renderer)
//{ 
//    renderer->AddActor(actor); 
//}
//
//void VelocityGlyphVisualization::removeFromRenderer(vtkRenderer* renderer)
//{ 
